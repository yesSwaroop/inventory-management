...
const Services = () => {
  ...
  return (
    ...
    >
      ...
      >
        <Text fontSize={isLargerThanLG ? '5xl' : '4xl'} fontWeight="bold" className='magic'>
          We build, We revive
        </Text>
        ...
        <Button width="200px" size="lg" colorScheme="blue" onClick={() => window.location.replace("/#contactus")}>
          CONTACT US
        </Button>
      </Flex>
    </Flex>
